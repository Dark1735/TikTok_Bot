...
os.system("xdg-open https://youtube.com/@anonymouscontent17")
if "linux" in sys.platform.lower():
	os.system(
			"clear"
	)
...
if __name__ == "__main__":
    os.system("cls" if os.name == "nt" else "clear"); os.system("title TikTok Viewbot by @anonymous_content" if os.name == "nt" else "")
    txt = """\n\n ╦  ╦╦╔═╗╦ ╦╔╗ ╔═╗╔╦╗\n ╚╗╔╝║║╣ ║║║╠╩╗║ ║ ║ \n  ╚╝ ╩╚═╝╚╩╝╚═╝╚═╝ ╩\n- Youtube: Anonymous Content\n- Script : anonymous content\n- Creator: @dikha"""
    print(
        Colorate.Vertical(
